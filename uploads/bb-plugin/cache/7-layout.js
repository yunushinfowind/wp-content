...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5b565219c768c',layout:'columns',pagination:'none',postSpacing:'0',postWidth:'300',matchHeight:{default:'0',medium:'',responsive:''},isRTL:false});});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5b565467a629a',layout:'columns',pagination:'none',postSpacing:'0',postWidth:'300',matchHeight:{default:'0',medium:'',responsive:''},isRTL:false});});})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'5b6c88446e319',layout:'columns',pagination:'numbers',postSpacing:'20',postWidth:'300',matchHeight:{default:'1',medium:'',responsive:''},isRTL:false});});})(jQuery);