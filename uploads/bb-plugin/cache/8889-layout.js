...
{return(e.which==1||e.which==13||e.which==32||e.which==undefined)?true:false;}};})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'5b5788a1cb539',defaultItem:false,labelIcon:'fas fa-plus',activeIcon:'fas fa-minus',});});})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'5b5789fb98858',defaultItem:false,labelIcon:'fas fa-plus',activeIcon:'fas fa-minus',});});})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'5b578a790d844',defaultItem:false,labelIcon:'fas fa-plus',activeIcon:'fas fa-minus',});});})(jQuery);(function($){$(function(){new FLBuilderAccordion({id:'5b578bc415157',defaultItem:false,labelIcon:'fas fa-plus',activeIcon:'fas fa-minus',});});})(jQuery);