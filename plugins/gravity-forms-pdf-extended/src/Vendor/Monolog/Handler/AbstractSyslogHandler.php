 ...
 */
abstract class AbstractSyslogHandler extends \GFPDF\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    protected $facility;
    /**
     * Translates Monolog log levels to syslog log priorities.
     */
    protected $logLevels = array(\GFPDF\Vendor\Monolog\Logger::DEBUG => \LOG_DEBUG, \GFPDF\Vendor\Monolog\Logger::INFO => \LOG_INFO, \GFPDF\Vendor\Monolog\Logger::NOTICE => \LOG_NOTICE, \GFPDF\Vendor\Monolog\Logger::WARNING => \LOG_WARNING, \GFPDF\Vendor\Monolog\Logger::ERROR => \LOG_ERR, \GFPDF\Vendor\Monolog\Logger::CRITICAL => \LOG_CRIT, \GFPDF\Vendor\Monolog\Logger::ALERT => \LOG_ALERT, \GFPDF\Vendor\Monolog\Logger::EMERGENCY => \LOG_EMERG);
    /**
     ...
     */
    public function __construct($facility = \LOG_USER, $level = \GFPDF\Vendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
    ...
    {
        return new \GFPDF\Vendor\Monolog\Formatter\LineFormatter('%channel%.%level_name%: %message% %context% %extra%');
    }
}
