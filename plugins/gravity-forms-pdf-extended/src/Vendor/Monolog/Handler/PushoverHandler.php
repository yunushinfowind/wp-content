 ...
 */
class PushoverHandler extends \GFPDF\Vendor\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \GFPDF\Vendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \GFPDF\Vendor\Monolog\Logger::CRITICAL, $emergencyLevel = \GFPDF\Vendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \GFPDF\Vendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \GFPDF\Vendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
