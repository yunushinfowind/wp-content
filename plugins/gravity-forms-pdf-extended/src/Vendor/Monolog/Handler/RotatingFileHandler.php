 ...
 */
class RotatingFileHandler extends \GFPDF\Vendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \GFPDF\Vendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \GFPDF\Vendor\Monolog\Utils::canonicalizePath($filename);
