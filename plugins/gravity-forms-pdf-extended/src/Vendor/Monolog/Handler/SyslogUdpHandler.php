...
use GFPDF\Vendor\Monolog\Handler\SyslogUdp\UdpSocket;
/**
 ...
 */
class SyslogUdpHandler extends \GFPDF\Vendor\Monolog\Handler\AbstractSyslogHandler
{
    const RFC3164 = 0;
    const RFC5424 = 1;
     ...
     */
    public function __construct($host, $port = 514, $facility = \LOG_USER, $level = \GFPDF\Vendor\Monolog\Logger::DEBUG, $bubble = \true, $ident = 'php', $rfc = self::RFC5424)
    {
        parent::__construct($facility, $level, $bubble);
        $this->ident = $ident;
        $this->rfc = $rfc;
        $this->socket = new \GFPDF\Vendor\Monolog\Handler\SyslogUdp\UdpSocket($host, $port ?: 514);
    }
