...
use GFPDF\Vendor\RollbarNotifier;
use Exception;
 ...
 */
class RollbarHandler extends \GFPDF\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     * Rollbar notifier
     *
    ...
    protected $levelMap = array(\GFPDF\Vendor\Monolog\Logger::DEBUG => 'debug', \GFPDF\Vendor\Monolog\Logger::INFO => 'info', \GFPDF\Vendor\Monolog\Logger::NOTICE => 'info', \GFPDF\Vendor\Monolog\Logger::WARNING => 'warning', \GFPDF\Vendor\Monolog\Logger::ERROR => 'error', \GFPDF\Vendor\Monolog\Logger::CRITICAL => 'critical', \GFPDF\Vendor\Monolog\Logger::ALERT => 'critical', \GFPDF\Vendor\Monolog\Logger::EMERGENCY => 'critical');
    /**
     ...
     */
    public function __construct(\GFPDF\Vendor\RollbarNotifier $rollbarNotifier, $level = \GFPDF\Vendor\Monolog\Logger::ERROR, $bubble = \true)
    {
