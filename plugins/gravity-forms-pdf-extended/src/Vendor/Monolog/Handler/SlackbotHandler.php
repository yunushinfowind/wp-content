 ...
 */
class SlackbotHandler extends \GFPDF\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \GFPDF\Vendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
