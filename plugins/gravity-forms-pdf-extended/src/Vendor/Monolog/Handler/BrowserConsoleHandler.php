 ...
 */
class BrowserConsoleHandler extends \GFPDF\Vendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \GFPDF\Vendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
